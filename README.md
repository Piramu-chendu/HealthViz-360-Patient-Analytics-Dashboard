...
1.Tableau Public - Data visualization and dashboard creation

2.CSV Files - Raw data source format

3.Tableau Relationships - Multi-table data modeling

4.Calculated Fields - Custom metrics (Age, Encounter Class)
...
✅ Multi-table data relationships (7 CSV files connected)

✅ Custom calculated fields for Age and Encounter Classification

✅ Top N filters to highlight most impactful data
...
2.Use the Story navigation tabs at the top to switch between dashboards

3.Click on any chart element to filter related visuals

4.Use dropdown filters to explore specific encounter types or organizations
